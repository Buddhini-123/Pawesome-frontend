      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-14">
        <div className="text-center mb-8">
          ...
          <p className="text-primary-blue text-base leading-relaxed font-fredoka">
            Sign in to your Pawsome pet care account to order your pet food,
            manage your rewards, get advises and more !
          </p>
        </div>
        ...
        <div className="text-center mb-6">
          <span className="text-medium-gray text-base font-fredoka">
            New Member?{" "}
          </span>
          <Link
            to="/register"
            className="text-vibrant-orange font-fredoka font-medium text-base hover:underline"
          >
            Create Account
          </Link>
        </div>

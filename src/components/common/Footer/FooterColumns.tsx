...
const FooterColumns: React.FC = () => {
  ...
  return (
    // <section className="px-20 py-12 max-md:px-5 justify-center items-center ">
    ...
    //               <a 
    //                 href="#" 
    //                 className="text-medium-gray hover:text-primary-blue transition-colors duration-200 "
    //               >
    ...
    //   </div>
    // </section>
    <section className="px-20 py-12 max-md:px-5 flex justify-center items-center">
        ...
        <ul className="space-y-2">
          {column.items.map((item, itemIndex) => (
            <li key={itemIndex}>
              <a 
                href="#" 
                className="text-medium-gray hover:text-primary-blue transition-colors duration-200 flex items-center justify-center"
              >
                {item.icon && <span className="inline mr-2">{item.icon}</span>}
                <span className="group-hover:translate-x-1 transition-transform duration-200">
                  {item.text}
